...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/common/homepage.css">
			...
			<div class="categoryArea" style="margin-top: 60px;">
                ...
                <c:forEach var="prdItem" items="${prdlist}">
                    <div class="categoryItemArea" style="cursor: default;">
                        <a target="_blank" href="${pageContext.request.contextPath}/product/info?product_id=${prdItem.PRODUCT_ID}">
