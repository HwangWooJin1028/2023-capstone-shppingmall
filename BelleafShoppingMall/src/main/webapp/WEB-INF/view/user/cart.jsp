								...
								<c:forEach items="${map.list}" var="list" varStatus="i">
									<tr >
										...
										<c:if test="${not empty list.product_pic}">
											<span style="padding-top:10px;" class="item-imgarea">
											<img alt="${list.product_pic}" src="https://aws-bucket-capstone-belleaf.s3.ap-northeast-2.amazonaws.com/${list.product_pic}" >
											</span>
										</c:if>
										</td>
