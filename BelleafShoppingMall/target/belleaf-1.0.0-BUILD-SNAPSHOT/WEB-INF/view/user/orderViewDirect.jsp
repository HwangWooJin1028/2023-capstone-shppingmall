...
<body>
	...
	<div class="orderBody" style="margin-bottom: 90px; padding-top: 80px;">
		...
		<div class="orderInfoArea">
			<form action="/order/shoppingdirect" method="post" class="orderform">
				<div class="orderAddArea">
					<table class="orderAddTable">
						...
						<tr>
							...
							<input type="hidden" name="order_total" id="order_total" value="${productDirectMap.allSum }">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" id="member-addr" placeholder="도로명 주소를 입력하세요.." name="order_addr" required="required" style="width: 600px;"></td>
						</tr>
						<tr>
							<td class="table-title">상세 주소</td>	
							<td><input type="text" id="member-addr-d" placeholder="상세주소를 입력하세요.." name="order_addr_d" required="required" style="width: 600px;"></td>
						</tr>
					</table>
				</div>
