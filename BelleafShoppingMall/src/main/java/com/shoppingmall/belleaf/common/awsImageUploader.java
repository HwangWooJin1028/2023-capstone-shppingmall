...
public class awsImageUploader {
    ...
    public String checkFileType(MultipartFile multipartFile) throws IOException {
        ...
        if (!(MediaType.IMAGE_JPEG_VALUE.equals(fileType) || MediaType.IMAGE_PNG_VALUE.equals(fileType) || MediaType.IMAGE_GIF_VALUE.equals(fileType) || fileType.equals("image/webp"))) {
