...
<body oncontextmenu="return false" ondragstart="return false" onselectstart="return false">
	...
	<div class="Paymentbody" style="padding-top: 80px;">
		<!-- 제목 부분 -->
		<div class="page-nav">홈><a href="${pageContext.request.contextPath}/cart/list">장바구니</a>>결제</div>
		...
		<div class="payArea">
			...
			<div class="payProductArea">
				...
				<table class="payProductTable" style="width:98%;">
					...
					<c:forEach items="${cartMap.list}" var="list" varStatus="i">
						<tr>
							<td>${list.product_name}</td>
							<td><fmt:formatNumber type="number" pattern="###,###,###" value="${list.product_price}"/>원</td>
							<td>${list.cart_product_qty}</td>
							<td><fmt:formatNumber type="number" pattern="###,###,###" value="${list.product_price*list.cart_product_qty}"/>원</td>
							<td><fmt:formatNumber type="percent" value="${list.product_discount}"/></td>
							<td><fmt:formatNumber type="number" pattern="###,###,###" value="${(list.product_price*list.cart_product_qty)-(list.product_price*list.cart_product_qty*list.product_discount) }"/>
							</td>
						</tr>
					</c:forEach>
				</table>
			...
			<h3>결제 금액 정보</h3>
				<table class="payMoneyTable">
					<tr>
						...
						<td><fmt:formatNumber type="number" pattern="###,###,###" value="${cartMap.sumMoney*(1-cartMap.discount)}"/>원</td>
					</tr>
					<tr>
						<td style="padding-right:10px;">배송비: </td>
						<td><fmt:formatNumber type="number" pattern="###,###,###" value="${cartMap.fee}"/>원</td>
					</tr>
					<tr>
						<td style="padding-right:10px;">총 결제금액: </td>
						<td><fmt:formatNumber type="number" pattern="###,###,###" value="${cartMap.allSum}"/>원</td>
					</tr>
				</table>
			</div>
			<hr>
			<div class="payinfo-area">
				<br>
			...
			<div class="payBtnArea">
				<button id="paymemt" type="button">결제하기</button>
