...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/store/ProductCategoryList.css?after">
			...
			<div class="categoryAllItemArea">
				<c:forEach items="${prdList}" var="product">
					<div class="categoryItemArea">
						<a href="${pageContext.request.contextPath}/product/info?product_id=${product.PRODUCT_ID}">
